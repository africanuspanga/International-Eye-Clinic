        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="relative">
            <div className="relative rounded-2xl overflow-hidden shadow-xl shadow-black/10 aspect-[4/5]">
              <Image src="/images/about-homepage.jpeg" alt="International Eye Hospital facility" fill className="object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#e62d26]/30 to-transparent" />
            </div>

            {/* Stat badge */}
            <div className="absolute -bottom-5 -right-5 lg:-right-8 bg-[#e62d26] text-white rounded-2xl p-5 shadow-xl">
            ...
            {/* Red accent */}
            <div className="absolute top-1/3 -left-3 w-1 h-20 bg-[#1a2a6c] rounded-full" />
          </div>
          ...
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-[#111827] leading-tight mb-5" style={{ fontFamily: "'Merriweather', serif" }}>
              ...
              <span className="text-[#e62d26]">Eye Care</span> Institution
            </h2>
            ...
            <ul className="grid sm:grid-cols-2 gap-3 mb-8">
              {values.map((v) => (
                <li key={v} className="flex items-start gap-2.5">
                  <CheckCircle2 size={16} className="text-[#e62d26] mt-0.5 flex-shrink-0" />
            ...
            <div className="flex gap-3 flex-wrap">
              <Link href="/about"
                className="bg-[#e62d26] hover:bg-[#c4201a] text-white font-semibold px-7 py-3 rounded-full text-sm transition-colors"
                style={{ fontFamily: "'Poppins', sans-serif" }}>
                Learn More About Us
              </Link>
              <Link href="/appointment"
                className="border-2 border-[#e62d26] text-[#e62d26] hover:bg-[#fdecea] font-semibold px-7 py-3 rounded-full text-sm transition-colors"
                style={{ fontFamily: "'Poppins', sans-serif" }}>
                Book Appointment
              </Link>
            </div>
