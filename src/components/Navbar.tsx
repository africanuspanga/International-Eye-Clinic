        ...
        <div className="max-w-7xl mx-auto px-6 py-2 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <a href="https://www.facebook.com/IEH.TZ/" target="_blank" rel="noopener noreferrer" className="hover:text-white/80 transition-colors" title="Facebook">
              ...
              <a href="https://x.com/IEH_tz" target="_blank" rel="noopener noreferrer" className="hover:text-white/80 transition-colors" title="X">
