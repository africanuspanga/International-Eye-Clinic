...
export default function AppointmentSection() {
  return (
    <section id="booking" className="py-20 bg-[#fdecea]">
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-start">
          ...
          <div className="lg:pt-4">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-[#111827] leading-tight mb-5" style={{ fontFamily: "'Merriweather', serif" }}>
              Book Your Eye<br />
              <span className="text-[#e62d26]">Examination</span> Today
            </h2>
            ...
            <div className="space-y-3 mb-8">
              <a href="tel:+255784104300"
                className="flex items-center gap-4 bg-white rounded-xl p-4 shadow-sm hover:shadow-md border border-gray-100 hover:border-[#e62d26]/20 transition-all group">
                ...
                <div>
                  ...
                  <p className="font-semibold text-[#e62d26] text-sm" style={{ fontFamily: "'Poppins', sans-serif" }}>+255 784 104 300</p>
                </div>
              </a>
              <a href="mailto:info@eye.co.tz"
                ...
                <div>
                  ...
                  <p className="font-semibold text-[#e62d26] text-sm" style={{ fontFamily: "'Poppins', sans-serif" }}>info@eye.co.tz</p>
                </div>
              </a>
              <div className="flex items-start gap-4 bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                <div className="w-11 h-11 bg-[#eaecf4] rounded-xl flex items-center justify-center flex-shrink-0">
                  <MapPin size={18} className="text-[#e62d26]" />
                </div>
                <div>
            ...
            <div className="flex items-start gap-3 bg-[#e8edf7] border border-[#1a2a6c]/20 rounded-xl p-4">
              ...
              <div>
                <p className="font-semibold text-[#1a2a6c] text-sm mb-0.5" style={{ fontFamily: "'Poppins', sans-serif" }}>Eye Emergency?</p>
                <p className="text-[#374151] text-sm" style={{ fontFamily: "'Poppins', sans-serif" }}>
                  Call us immediately: <a href="tel:+255784104300" className="font-bold text-[#1a2a6c]">+255 784 104 300</a>
                </p>
              </div>
            </div>
          </div>
